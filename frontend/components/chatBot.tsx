...
const getFrontendAuthHeaders = (user: ReturnType<typeof useUser>['user']) => {
...
export default function Twin() {
    ...
    const sendMessage = async () => {
        if (!input.trim() || isLoading || !isLoaded || !user) return;
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/chat`, {
                method: 'POST',
                headers: getFrontendAuthHeaders(user),
                body: JSON.stringify({
    ...
    const readAssistantStream = async (response: Response, assistantMessageId: string) => {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50 rounded-lg shadow-lg">
            ...
            <div className="bg-gradient-to-r from-slate-700 to-slate-800 text-white p-4 rounded-t-lg">
                ...
                <p className="text-sm text-slate-300 mt-1">Meridian Electronics AI ChatBot</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {messages.length === 0 && (
                    <div className="text-center text-gray-500 mt-8">
                        ...
                        <p>Hello! I&apos;m your Meridian Electronics assistant.</p>
                        <p className="text-sm mt-2">
                            Ask me about product availability, order placement, or order history.
                        </p>
                    </div>
                )}
            ...
            <div className="border-t border-gray-200 p-4 bg-white rounded-b-lg">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={sendMessage}
                        disabled={!input.trim() || isLoading || !isLoaded || !user}
